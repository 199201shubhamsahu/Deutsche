...
class Colours{
    ...
    var englishColour: String =""
    var germanColour: String =""
}

class ColoursActivity: NavigationView.OnNavigationItemSelectedListener, AppCompatActivity () {//TODO 3
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_colours)//TODO 4
    ...
    public override fun onStart() {
        ...
        mAuthListener = FirebaseAuth.AuthStateListener { firebaseAuth ->
            ...
            if (user == null) {
                ...
                mDrawerLayout = findViewById(R.id.drawer_layout_colours)//TODO 1
                ...
                val navigationView = findViewById<NavigationView>(R.id.nav_view_colours)//TODO 2
                ...
                mDatabaseReference = mFireBaseDatabase.getReference("Colours")

                colour_recycler_list.layoutManager = LinearLayoutManager(this)
                colour_recycler_list.adapter = TwoColRecyclerAdapter(itemList1, itemList2, this)

                mDatabaseReference.addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(dataSnapshot: DataSnapshot) {

                        for(dataSnapshot1: DataSnapshot in dataSnapshot.children){
                            val value = dataSnapshot1.getValue(Colours::class.java)
                            itemList1.add(value!!.englishColour)
                            itemList2.add(value.germanColour)
                        }
                        colour_recycler_list.adapter!!.notifyDataSetChanged()
                    }
